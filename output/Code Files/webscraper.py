...
def get_soup(url):
    ...
    #driver = webdriver.Chrome(executable_path = '/media/sf_Shared_VB/persp/chromedriver_linux64', chrome_options=options)
    ...
    #ATTEMPT TO CLICK ON CHECKBOX

    #Code to click on traveltype checkbox
    # wait = WebDriverWait(driver, 10)
    # element = wait.until(EC.element_to_be_clickable((By.ID, 'TravelTypeFilter_2')))

    # solo = driver.find_element_by_id("TravelTypeFilter_2")
    # driver.implicitly_wait(10)
    # solo.click()

    # button = driver.find_element_by_class_name(u"ui_checkbox hotels-review-list-parts-ReviewFilter__filter_row--2sfwt")
    # driver.implicitly_wait(10)
    # ActionChains(driver).move_to_element(button).click(button)
    # button = driver.find_element_by_id("TravelTypeFilter_2")
    # ActionChains(button).move_to_element(button).click().perform()
